...
#ifndef SGFM_FIRST_ORDER_HPF_HPP
#define SGFM_FIRST_ORDER_HPF_HPP
...
namespace SGFM {
	...
	/*
	 * FirstOrderHPF - First order high pass filter.
	 * This component simulates filter described as (1+sT).
	 */
	class FirstOrderHPF : public FirstOrderFilter {
		public:
